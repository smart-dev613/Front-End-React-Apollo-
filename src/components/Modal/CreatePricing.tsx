...
import CreatePricingContent from './components/CreatePricingContent';
...
class CreatePricing extends Component<Props, NewVenueState> {
  public render() {
    return (
      <Translation>
        {
...
export default compose(withApollo, connect(mapStateToProps, mapDispatchToProps))(CreatePricing)
