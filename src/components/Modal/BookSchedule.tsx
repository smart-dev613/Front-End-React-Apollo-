...
import BookScheduleContent from './components/BookScheduleContent';
...
class BookSchedule extends Component<Props, NewVenueState> {
  public render() {
    return (
      <Translation>
        {() => (
          <StyledBookScheduleModal className="modal-content">
            {console.log("booking modal props", this.props)}
            <BookScheduleContent
              ui={this.props.ui}
...
const StyledBookScheduleModal = styled.div`
