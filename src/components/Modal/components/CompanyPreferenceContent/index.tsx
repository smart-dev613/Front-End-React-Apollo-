...
/** Constants */
import { CompanyPreferenceList } from '../../../enum/preference';

/** Types */
import { Props } from './types';

const CompanyPreferenceContent: React.FC<Props> = (props: Props) => {
  const {
    ui,
    user,
    closeCurrentModal,
  ...
  const closeModal = () => {
    closeCurrentModal('COMPANY_PREFERENCE')
  }
        ...
        <Form>
          <div className="modal-header">
            ...
            <div style={{ display: 'flex', gap: 5 }}>
              <button type="submit" className="btn btn-purple btn-edit btn-content" style={{ color: '#fff' }}>
          ...
          <ModalBody className="modal-body">
            <FormRow>
              {CompanyPreferenceList.map((list: any) => (
                <CheckboxGroupField
...
export default CompanyPreferenceContent
