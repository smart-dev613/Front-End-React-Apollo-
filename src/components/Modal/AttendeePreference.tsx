...
import AttendeePreferenceContent from './components/AttendeePreferenceContent';
...
class AttendeePreference extends Component<Props, NewVenueState> {
  public render() {
    return (
      <Translation>
        {
...
export default compose(withApollo, connect(mapStateToProps, mapDispatchToProps))(AttendeePreference)
