...
import CompanyPreferenceContent from './components/CompanyPreferenceContent';
...
class CompanyPreference extends Component<Props, NewVenueState> {
  public render() {
    return (
      <Translation>
        {
...
export default compose(withApollo, connect(mapStateToProps, mapDispatchToProps))(CompanyPreference)
